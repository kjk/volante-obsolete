...
public abstract class Storage { 
     ...
     */
    abstract public <T extends IPersistent> IPersistentSet<T> createScalableSet();
     ...
     * @return scalable set implementation
     */
    abstract public <T extends IPersistent> IPersistentSet<T> createScalableSet(int initialSize);
     ...
     * specified key type is not supported by implementation.
     */
    abstract public <T extends IPersistent> Index<T> createThickIndex(Class type);
