...
class File(object):
    ...
    def _calc_names(self):
        # self.url is an absolute path (e.g. c:\Users\kkowalczyk\src\nachodb\csharp\src\impl\XMLExporter.cs)
...
def gen_html_for_files(files, html_out_dir):
    for f in sorted(files):
        ...
        html_path = os.path.join(html_out_dir, f.html_file_name)
...
def gen_index_html(types, files, html_out_dir, html_file_name):
...
def main():
    ...
    gen_index_html(types, files, html_out_dir, "index.html")
